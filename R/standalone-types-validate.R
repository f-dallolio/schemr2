...
validate_number_decimal <- function(x,
                                 ...,
                                 min = NULL,
                                 max = NULL,
                                 allow_infinite = TRUE,
...
validate_number_whole <- function(x,
                               ...,
                               min = NULL,
                               max = NULL,
...
validate_call <- function(x,
                       ...
                       call = caller_env()) {
  if (!missing(x)) {
    if (is_call(x, name = name, n = n, ns = ns)) {
      return(x)
    }
    if (allow_null && is_null(x)) {
      return(x)
...
validate_call_simple <- function(x,
                              ...,
                              allow_null = FALSE,
                              arg = caller_arg(x),
                              call = caller_env()) {
